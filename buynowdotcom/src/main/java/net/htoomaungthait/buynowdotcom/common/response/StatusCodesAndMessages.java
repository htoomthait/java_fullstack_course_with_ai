...
public class StatusCodesAndMessages {
    ...
    private static final List<StatusCodeAndMessage> statusCodesAndMessages = List.of(
            ...
            StatusCodeAndMessage.of("USER_009", "User info with cart and order listed successfully."),
            ...
            StatusCodeAndMessage.of("CART_002", "User's cart has been cleared successfully."),
            StatusCodeAndMessage.of("CART_003", "User's cart has not found."),
